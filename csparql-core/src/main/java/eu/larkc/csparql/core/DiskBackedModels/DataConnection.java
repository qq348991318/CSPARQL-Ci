package eu.larkc.csparql.core.DiskBackedModels;



public class DataConnection {

	/*static protected String connectionString = "jdbc:virtuoso://localhost:1111/autoReconnect=true/charset=UTF-8/log_enable=2";
	static protected String username = "dba";
	static protected String password = "dba";
