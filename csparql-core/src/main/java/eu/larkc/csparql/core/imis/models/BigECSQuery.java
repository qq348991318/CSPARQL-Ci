...
public class BigECSQuery {
	...
	static HashSet<eu.larkc.csparql.core.imis.models.BigECSTree> visited = new LinkedHashSet<eu.larkc.csparql.core.imis.models.BigECSTree>();
	...
	eu.larkc.csparql.core.imis.models.BigECSTree BigECSTree ;
...
//		System.out.println(subjectBindsMap.toString());
		...
		HashMap<BigExtendedCharacteristicSet, eu.larkc.csparql.core.imis.models.BigECSTree> BigECSTreeMap = new HashMap<BigExtendedCharacteristicSet, eu.larkc.csparql.core.imis.models.BigECSTree>();
...
//			System.out.println(triple.toString());
		...
		for(TriplePath triplePath : triplePathBlock.getPattern().getList()){
			...
			Node object = triple.getObject();
	 		...
	 		if(subjectMap.containsKey(object)){
	 			...
	 			eu.larkc.csparql.core.imis.models.BigECSTree thisTree = new BigECSTree(ecs);
		 		BigECSTree.addChild(thisTree);
		 		BigECSTreeMap.put(ecs, thisTree);
		...
		for(BigExtendedCharacteristicSet ecs : ecsLinks.keySet()){
			...
			eu.larkc.csparql.core.imis.models.BigECSTree leftECS = BigECSTreeMap.get(ecs);
			/*
			...
			for(BigExtendedCharacteristicSet link : ecsLinks.get(ecs)){
				eu.larkc.csparql.core.imis.models.BigECSTree rightECS = BigECSTreeMap.get(link);
		...
		for(eu.larkc.csparql.core.imis.models.BigECSTree child : BigECSTree.children){
	...
	public eu.larkc.csparql.core.imis.models.BigECSTree getBigECSTree() {
		return BigECSTree;
	}

	public void setBigECSTree(eu.larkc.csparql.core.imis.models.BigECSTree BigECSTree) {
		this.BigECSTree = BigECSTree;
	}

	static public void recursiveDFS(eu.larkc.csparql.core.imis.models.BigECSTree cur, LinkedHashSet<BigExtendedCharacteristicSet> list){
		...
		visited.add(cur);
		list.add(cur.root);
		for(eu.larkc.csparql.core.imis.models.BigECSTree child : cur.children){
	...
	static public void iterativeDFS(eu.larkc.csparql.core.imis.models.BigECSTree tree){

		Stack<eu.larkc.csparql.core.imis.models.BigECSTree> stack = new Stack<eu.larkc.csparql.core.imis.models.BigECSTree>();
		stack.push(tree);
		HashSet<eu.larkc.csparql.core.imis.models.BigECSTree> visited  = new HashSet<eu.larkc.csparql.core.imis.models.BigECSTree>();
		while(!stack.empty()){
			tree = stack.pop();
			if(tree == null ) {
			...
			visited.add(tree);
			for(eu.larkc.csparql.core.imis.models.BigECSTree child : tree.children){
