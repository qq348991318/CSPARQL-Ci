...
import eu.larkc.csparql.core.imis.models.BigCharacteristicSet;
import eu.larkc.csparql.core.imis.models.BigExtendedCharacteristicSet;
...
public class BigLoader {
	...
	public static void main(String[] args) {
		List<RDFTriple> list = new ArrayList<>();
		list.add(new RDFTriple("a", "b", "c"));
		list.add(new RDFTriple("d", "b", "c"));
//		loadStream(list, );
	}

	public static void loadStream(List<RDFTriple> list, String indexPath, String newIndexPath) {
//		./mapdb ./newMapdb /Users/yangfanyu/IdeaProjects/csparql_spark/csparql-reason/src/main/java/dataset/lubm1000000.nt
