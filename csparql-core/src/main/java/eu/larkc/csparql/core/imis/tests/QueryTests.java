...
public class QueryTests {
	...
	public static void main(String[] args) {
		...
		//args[0] = "C:/temp/temp" ;
		DB db = DBMaker.newFileDB(new File("/Users/yangfanyu/IdeaProjects/csparql_spark/csparql-core/src/main/java/eu/larkc/csparql/core/imis/tests/mapdb"))
 		...
 		for(String qs : lubm.getQueries(1)){
 			...
 			times = new ArrayList<Long>();
		 		...
		 		for(int i = 0; i < 10; i++){
			 		...
			 		Collections.sort(f, new BigQueryTests.ECSTupleComparator());
