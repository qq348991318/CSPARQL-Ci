...
/**
 * @author 杨帆玉
 * @date 2019/11/6 3:47 下午
 */
public class StreamProducer {
    public static final Logger logger = LoggerFactory.getLogger(StreamProducer.class);
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            PostStream postStream = new PostStream("http://streamreasoning.org/streams/post", "http://www.streamreasoning.org/ontologies/sr4ld2014-onto#", 12000);
