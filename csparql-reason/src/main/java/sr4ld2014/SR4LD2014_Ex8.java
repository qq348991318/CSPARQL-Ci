...
import sr4ld2014.streamer.FacebookStreamer;

public class SR4LD2014_Ex8 {

	private static Logger logger = LoggerFactory.getLogger(SR4LD2014_Ex8.class);
	...
	public static void main(String[] args) {
		...
		try{
			...
			FacebookStreamer fb = new FacebookStreamer("http://streamreasoning.org/streams/fb", "http://www.streamreasoning.org/ontologies/sr4ld2014-onto#", 1L);
