...
import sr4ld2014.streamer.FoursquareStreamer;
...
public class SR4LD2014_Ex1 {
	...
	public static void main(String[] args) {
		...
		try{
			...
			FoursquareStreamer fs = new FoursquareStreamer("http://streamreasoning.org/streams/fs", "http://www.streamreasoning.org/ontologies/sr4ld2014-onto#", 1L);
